...
class FillItUpHelperExtension
{
    ...
    public static function generateTmpFolder()
    {
    ...
    public static function removeTmpFolder($folder)
    {
        jimport('joomla.filesystem.folder');
    ...
    public static function donwloadCategoryImages($categoryID, $categoryName, $definitions, $folder)
    {
    ...
    public static function updateDefinitions(&$definitions, $categoryID, $categoryName)
    {
        foreach ($definitions as $definition) {
            if ($definition->name == $categoryName) {
